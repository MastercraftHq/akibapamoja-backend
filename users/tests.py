...
class ProfilePictureTests(APITestCase):
    ...
    def test_upload_picture_success(self):
        self.authenticate()
        image = SimpleUploadedFile("test_image.jpg", self.jpeg_data, content_type="image/jpeg")
        data = {"avatar": image}
